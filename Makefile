#############################################################################
# Makefile for building: ImgSonification
# Generated by qmake (3.1) (Qt 5.10.1)
# Project:  ImgSonification.pro
# Template: app
# Command: /home/ohini/Qt/5.10.1/gcc_64/bin/qmake -o Makefile ImgSonification.pro -spec linux-g++
#############################################################################
...
CXXFLAGS      = -pipe -g -std=gnu++11 -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I../../../Qt/5.10.1/gcc_64/include -I../../../Qt/5.10.1/gcc_64/include/QtGui -I../../../Qt/5.10.1/gcc_64/include/QtCore -I. -isystem /usr/include/libdrm -I../../../Qt/5.10.1/gcc_64/mkspecs/linux-g++
QMAKE         = /home/ohini/Qt/5.10.1/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/ohini/Qt/5.10.1/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/ohini/Qt/5.10.1/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = ImgSonification1.0.0
DISTDIR = /home/ohini/Documents/Sonification/ProgSonif/.tmp/ImgSonification1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/ohini/Qt/5.10.1/gcc_64/lib
LIBS          = $(SUBLIBS) -lm -lX11 -L/home/ohini/Qt/5.10.1/gcc_64/lib -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = FunctionSonif.cc \
		ImgSonification.cc 
OBJECTS       = FunctionSonif.o \
		ImgSonification.o
DIST          = ../../../Qt/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
		...
		ImgSonification.pro FunctionSonif.h FunctionSonif.cc \
		ImgSonification.cc
QMAKE_TARGET  = ImgSonification
DESTDIR       = 
TARGET        = ImgSonification
...
Makefile: ImgSonification.pro ../../../Qt/5.10.1/gcc_64/mkspecs/linux-g++/qmake.conf ../../../Qt/5.10.1/gcc_64/mkspecs/features/spec_pre.prf \
		../../../Qt/5.10.1/gcc_64/mkspecs/common/unix.conf \
		../../../Qt/5.10.1/gcc_64/mkspecs/common/linux.conf \
		../../../Qt/5.10.1/gcc_64/mkspecs/common/sanitize.conf \
		../../../Qt/5.10.1/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../../Qt/5.10.1/gcc_64/mkspecs/features/unix/thread.prf \
		ImgSonification.pro
	$(QMAKE) -o Makefile ImgSonification.pro -spec linux-g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents FunctionSonif.h $(DISTDIR)/
	$(COPY_FILE) --parents FunctionSonif.cc ImgSonification.cc $(DISTDIR)/
...
FunctionSonif.o: FunctionSonif.cc FunctionSonif.h \
		ThermicScale.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FunctionSonif.o FunctionSonif.cc

ImgSonification.o: ImgSonification.cc FunctionSonif.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ImgSonification.o ImgSonification.cc
